...
# Filter out lines with a delta value of 0
filtered_lines = [line for line in lines if line.split()[1] != '0']

# Write the filtered lines to a new file
with open('filted_delta.txt', 'w') as f:
    f.writelines(filtered_lines)
...
# Read the file
with open('filted_delta.txt', 'r') as f:
    lines = f.readlines()
